...
function showAdminUI() {
    ...
    document.getElementById('admin-login-btn').style.display = loggedIn ? 'none' : 'inline-block';
    document.getElementById('admin-panel-btn').style.display = loggedIn ? 'inline-block' : 'none';
